...
Basic infrastructure and several algorithms for __1d - 4d bin packing problem__. The __gbp__ package provides a set of __c-level classes and solvers for 1d - 4d bin packing problem__, and __an r-level solver for 4d bin packing problem__, which is a wrapper over the c-level 4d bin packing problem solver. 
...
A [shiny application](https://gyang.shinyapps.io/gbp_app/) that demonstrate how to use how to use __gbp__ function __bpp_solver__ in fulfilling the order packing process in business operations.
